...
export default function App() {
  ...
  const login = async () => {
    try {
      ...
      alert("Login Pi falló. Ejecuta dentro del Pi Browser con wallet configurada.");
    }
  };
  ...
  const payOnePi = async (toUsername) => {
    ...
    try {
      ...
      console.error(e);
      alert("Debe ejecutarse dentro del Pi Browser con wallet configurada.");
    }
  };

  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: 16, fontFamily:"system-ui, Arial" }}>
      <h1>Synkronía Pi — Talent Match</h1>
      ...
      <section style={{ marginTop: 24 }}>
        ...
        <p>Explora tarjetas y prueba un pago 1 Pi de demo:</p>
